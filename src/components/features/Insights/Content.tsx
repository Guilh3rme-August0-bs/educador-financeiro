...
export function Content({ insight }: ContentProps) {
    ...
    return (
        <div className="lg:scrollbar-thin lg:max-h-84 1g: overflow-y-auto lg:pr-2 1g: [scrollbar-color:var(--border)_transparent]">
            ...
            <section>
                <SectionTitle>Como Aumentar a sua Renda</SectionTitle>
                <Paragraph>{insight.extraIncome.items}</Paragraph>
            </section>

            <section>
                <SectionTitle>Sugestões de Investimento</SectionTitle>
                <Paragraph>{insight.investment.items}</Paragraph>
            </section>
